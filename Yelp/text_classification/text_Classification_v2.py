...
def read_dataset():
    ...
    global x_train, x_test, yelp_test, yelp
    ...
    return(x_train, x_test, yelp_test, yelp)
...
def main():
    ...
    x_train, x_test, yelp_test, yelp = read_dataset()
    ...
    # Call the fir and evaluate function for Yelp                        
